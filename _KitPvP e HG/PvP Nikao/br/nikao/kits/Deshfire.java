...
/*  28 */   public static ArrayList<String> sonic = new ArrayList();
/*  29 */   ArrayList<String> fall = new ArrayList();
/*  30 */   public static List<Player> cooldownm = new ArrayList();
/*  31 */   public static HashMap<String, ItemStack[]> Armadura = new HashMap();
/*     */   
/*     */   @EventHandler
/*     */   public void VelotrolClick(PlayerInteractEvent e) {
/*  35 */     final Player p = e.getPlayer();
/*  36 */     if ((e.getPlayer().getItemInHand().getType() == Material.REDSTONE_BLOCK) && (br.nikao.outros.KitAPI.getkit(p) == "Deshfire")) {
...
/*  42 */         p.sendMessage("§c§lAguarde o cooldown acabar!");
/*  43 */         return;
/*     */       }
/*  45 */       cooldownm.add(p);
...
/*  98 */           p.sendMessage("§a§lVoce pode usar novamente!");
