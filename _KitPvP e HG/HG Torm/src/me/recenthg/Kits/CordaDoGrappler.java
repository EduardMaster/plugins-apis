...
public class CordaDoGrappler extends EntityFishingHook
{
  private Snowball sb;
  ...
  public CordaDoGrappler(org.bukkit.World world, EntityHuman entityhuman)
  {
...
public void spawn(Location location)
  {
    ...
    new PacketPlayOutEntityDestroy(new int[] { this.controller.getId() });
