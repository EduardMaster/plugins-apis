...
public class Main extends JavaPlugin {
	...
	private YamlConfiguration ranks;
	...
	public void onEnable() {
		...
		instance = this;
		saveDefaultConfig();
		File stats = new File(getDataFolder(), "StatsManager.yml");
		if (!stats.exists())
			saveResource("StatsManager.yml", false);
		stats1 = new File(getDataFolder(), "StatsManager.yml");
		...
		Bukkit.getConsoleSender().sendMessage("          §e§lCRINGED§7§LKITS        ");
		Bukkit.getConsoleSender().sendMessage("");
		Bukkit.getConsoleSender().sendMessage("                                         ");
	...
	public void RegisterEvents() {
		...
		Bukkit.getServer().getPluginManager().registerEvents(new ChatMute(null), this);
		Bukkit.getServer().getPluginManager().registerEvents(new Rank (), this);
	...
	public void Comandos() {
		...
		getCommand("setarena").setExecutor(new SetArena());
     	...
     	getCommand("fecharchat").setExecutor(new ChatMute(getInstace()));
	...
	public static void StatusManager(Player target, Integer valueOf) {
		// TODO Auto-generated method stub
