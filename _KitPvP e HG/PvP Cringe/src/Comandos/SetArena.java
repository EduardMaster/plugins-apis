...
public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args)
  {
    ...
    if ((p.hasPermission("cmd.dono")) && 
      ...
      if (args.length == 0)
      {
        p.sendMessage("§d§lARENA §fUse: /setarena 1/10");
        return true;
      }
      if (args[0].equalsIgnoreCase("1"))
      {
        p.sendMessage(ChatColor.GREEN + "§d§lARENA §fSetado SPAWNPOINT ARENA 1");
      ...
      {
        p.sendMessage(ChatColor.GREEN + "§d§lARENA §fSetado SPAWNPOINT ARENA 2");
      ...
      {
        p.sendMessage(ChatColor.GREEN + "§d§lARENA §fSetado SPAWNPOINT ARENA 3");
      ...
      {
        p.sendMessage(ChatColor.GREEN + "§d§lARENA §fSetado SPAWNPOINT ARENA 4");
      ...
      {
        p.sendMessage(ChatColor.GREEN + "§d§lARENA §fSetado SPAWNPOINT ARENA 5");
      ...
      {
        p.sendMessage(ChatColor.GREEN + "§d§lARENA §fSetado SPAWNPOINT ARENA 6");
      ...
      {
        p.sendMessage(ChatColor.GREEN + "§d§lARENA §fSetado SPAWNPOINT ARENA 7");
      ...
      {
        p.sendMessage(ChatColor.GREEN + "§d§lARENA §fSetado SPAWNPOINT ARENA 8");
      ...
      {
        p.sendMessage(ChatColor.GREEN + "§d§lARENA §fSetado SPAWNPOINT ARENA 9");
      ...
      {
        p.sendMessage(ChatColor.GREEN + "§d§lARENA §fSetado SPAWNPOINT ARENA 10");
